...
__attribute__ ((aligned(16))) uint8_t endpRXbuff[4096] __attribute__((section(".DMADATA"))); //data recive buffer
__attribute__ ((aligned(16))) uint8_t endpTXbuff[4096] __attribute__((section(".DMADATA"))); //data send buffer
...
volatile uint8_t device_link_status = 0;
volatile uint8_t config_value = 0;
volatile uint8_t g_DeviceConnectstatus = 0;
volatile uint8_t g_DeviceUsbType = 0;
