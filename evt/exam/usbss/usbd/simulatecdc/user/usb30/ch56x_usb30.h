...
extern __attribute__ ((aligned(16))) uint8_t  endp2Rxbuff[4096] __attribute__((section(".DMADATA")));
extern __attribute__ ((aligned(16))) uint8_t  endp2Txbuff[4096] __attribute__((section(".DMADATA")));
