...
__attribute__((aligned(16))) UINT8 UDisk_In_Buf[UDISKSIZE] __attribute__((section(".DMADATA"))); //Endpoint 2 data receiving and sending buffer
__attribute__((aligned(16))) UINT8 UDisk_Out_Buf[UDISKSIZE] __attribute__((section(".DMADATA"))); //Endpoint 3 data receiving and sending buffer
