...
__attribute__((aligned(16))) uint8_t UDisk_In_Buf[UDISKSIZE] __attribute__((section(".DMADATA"))); //Endpoint 2 data receiving and sending buffer
__attribute__((aligned(16))) uint8_t UDisk_Out_Buf[UDISKSIZE] __attribute__((section(".DMADATA"))); //Endpoint 3 data receiving and sending buffer
...
void USB30D_init(FunctionalState sta)
{
    ...
    if(sta)
    {
        ...
        USBSS->UEP_CFG = EP0_R_EN | EP0_T_EN | EP2_T_EN | EP3_R_EN ; // set end point rx/tx enable
