...
/******************************************************************************/
/* Hidden partition layout */
#define FRONT_PARTITION_SECTORS  (256UL * 1024 * 1024 / 512)  /* 256MB front partition */

/* Device state */
#define DEVICE_STATE_LOCKED      0
#define DEVICE_STATE_UNLOCKED    1
#define DEVICE_STATE_RENUM       2  /* Pending re-enumeration */

/* Password marker prefix scanned in write data */
#define UNLOCK_PREFIX            "UNLOCK:"
#define UNLOCK_PREFIX_LEN        7
#define MAX_PASSWORD_LEN         32

/* AES-256 key size in bytes and words */
#define AES_KEY_BYTES            32
#define AES_KEY_WORDS            (AES_KEY_BYTES / 4)

/* CTR nonce size (first 8 bytes of 16-byte IV) */
#define CTR_NONCE_BYTES          8
...
/* Device state and encryption globals */
extern volatile uint8_t  Device_State;
extern uint32_t          AES_Key[AES_KEY_WORDS];
extern uint32_t          CTR_Nonce[CTR_NONCE_BYTES / 4];
extern volatile uint32_t Hidden_Partition_Sectors;
...
extern void UDISK_Scan_Password( uint8_t *buf, uint32_t len );
