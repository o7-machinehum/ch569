...
void TMR0_EXTSignalCounterInit( uint32_t c );							/* External signal counting function initialization */
...
void TMR1_EXTSignalCounterInit( uint32_t c );							/* External signal counting function initialization */
...
void TMR2_EXTSignalCounterInit( uint32_t c );							/* External signal counting function initialization */
