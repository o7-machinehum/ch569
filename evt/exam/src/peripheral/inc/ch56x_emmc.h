...
extern uint8_t EMMCCardReadEXCSD( PSD_PARAMETER pEMMCPara, uint8_t * pRdatbuf );
extern uint8_t AES_EMMCWriteMulSec( PSD_PARAMETER pEMMCPara, uint32_t * pReqnum, uint32_t * pWdatbuf, uint32_t Lbaaddr, uint8_t excutemode, uint8_t endianmode, uint32_t * pcount);
extern uint8_t AES_EMMCReadMulSec( PSD_PARAMETER pEMMCPara, uint32_t * pReqnum, uint32_t * pRdatbuf, uint32_t Lbaaddr, uint8_t excutemode, uint8_t endianmode, uint32_t * pcount);
