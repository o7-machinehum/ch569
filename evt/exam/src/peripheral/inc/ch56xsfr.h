...
#define R32_SAFE_ACCESS         (*((volatile uint32_t *)0x40001000)) // RW, safe accessing
#define R8_SAFE_ACCESS_SIG      (*((volatile uint8_t *)0x40001000))  // WO, safe accessing sign register, must write 0x57 then 0xA8 to enter safe accessing mode
...
#define R8_CHIP_ID              (*((volatile uint8_t *)0x40001001))  // RF, chip ID register, always is ID_CH569W
#define R8_SAFE_ACCESS_ID       (*((volatile uint8_t *)0x40001002))  // RF, safe accessing ID register, always 0x02
#define R8_WDOG_COUNT           (*((volatile uint8_t *)0x40001003))  // RW, watch-dog count, count by clock frequency Fsys/524288

/* System: global configuration register */
#define R32_GLOBAL_CONFIG       (*((volatile uint32_t *)0x40001004)) // RW, global configuration
#define R8_GLOB_ROM_CFG         (*((volatile uint8_t *)0x40001004))  // RWA, flash ROM configuration, SAM and bit7:6 must write 1:0
...
#define R8_RST_BOOT_STAT        (*((volatile uint8_t *)0x40001005)) // RO, reset status and boot/debug status, bit7:6 always are 1:1
...
#define R8_RST_WDOG_CTRL        (*((volatile uint8_t *)0x40001006)) // RWA, reset and watch-dog control, SAM and bit7:6 must write 0:1
...
#define R8_GLOB_RESET_KEEP      (*((volatile uint8_t *)0x40001007)) // RW, value keeper during global reset

/* System: clock configuration register */
#define R32_CLOCK_CONFIG        (*((volatile uint32_t *)0x40001008)) // RWA, clock configuration, SAM
#define R8_CLK_PLL_DIV          (*((volatile uint8_t *)0x40001008))  // RWA, output clock divider from PLL, only low 4 bit, SAM and bit7:6 must write 0:1
#define R8_CLK_CFG_CTRL         (*((volatile uint8_t *)0x4000100A))  // RWA, clock control, SAM and bit7:6 must write 1:0
...
#define R8_CLK_MOD_AUX          (*((volatile uint8_t *)0x4000100B)) // RWA, clock mode aux register
...
#define R8_SLP_POWER_CTRL       (*((volatile uint8_t *)0x4000100F))  // RWA, power control, SAM
#define RB_SLP_USBHS_PWRDN      0x01                      // RWA, enable USBHS power down

/* System: port and bus configuration register */
#define R32_PORT_CONFIG         (*((volatile uint32_t *)0x40001010)) // RW, port and bus configuration
#define R8_XBUS_CONFIG          (*((volatile uint8_t *)0x40001010))  // RW, external bus configuration
...
#define R8_PIN_ALTERNATE        (*((volatile uint8_t *)0x40001012))  // RW, alternate pin control
...
#define R16_SERD_ANA_CFG1       (*((volatile uint16_t *)0x40001020)) //RWA, Serdes Analog parameter configuration1
#define R32_SERD_ANA_CFG2       (*((volatile uint32_t *)0x40001024)) //RWA, Serdes Analog parameter configuration2

/* System: GPIO interrupt control register */
#define R32_GPIO_INT_CTRL       (*((volatile uint32_t *)0x4000101C)) // RW, GPIO interrupt control
#define R8_GPIO_INT_FLAG        (*((volatile uint8_t *)0x4000101C))  // RW1, GPIO interrupt flag
#define R8_GPIO_INT_ENABLE      (*((volatile uint8_t *)0x4000101D))  // RW, GPIO interrupt enable
#define R8_GPIO_INT_MODE        (*((volatile uint8_t *)0x4000101E))  // RW, GPIO interrupt mode: 0=level action, 1=edge action
#define R8_GPIO_INT_POLAR       (*((volatile uint8_t *)0x4000101F))  // RW, GPIO interrupt polarity: 0=normal(low_level/fall_edge), 1=invert(high_level/rise_edge)

/* GPIO interrupt control register address offset and bit define */
#define BA_GPIO_INT_CTRL        ((volatile uint8_t *)0x4000101C) // point GPIO interrupt base address
...
/* GPIO PA register */
#define R32_PA_DIR              (*((volatile uint32_t *)0x40001040)) // RW, GPIO PA I/O direction: 0=in, 1=out
#define R8_PA_DIR_0             (*((volatile uint8_t *)0x40001040))  // RW, GPIO PA I/O direction byte 0
#define R8_PA_DIR_1             (*((volatile uint8_t *)0x40001041))  // RW, GPIO PA I/O direction byte 1
#define R8_PA_DIR_2             (*((volatile uint8_t *)0x40001042))  // RW, GPIO PA I/O direction byte 2
#define R32_PA_PIN              (*((volatile uint32_t *)0x40001044)) // RO, GPIO PA input
#define R8_PA_PIN_0             (*((volatile uint8_t *)0x40001044))  // RO, GPIO PA input byte 0
#define R8_PA_PIN_1             (*((volatile uint8_t *)0x40001045))  // RO, GPIO PA input byte 1
#define R8_PA_PIN_2             (*((volatile uint8_t *)0x40001046))  // RO, GPIO PA input byte 2
#define R32_PA_OUT              (*((volatile uint32_t *)0x40001048)) // RW, GPIO PA output
#define R8_PA_OUT_0             (*((volatile uint8_t *)0x40001048))  // RW, GPIO PA output byte 0
#define R8_PA_OUT_1             (*((volatile uint8_t *)0x40001049))  // RW, GPIO PA output byte 1
#define R8_PA_OUT_2             (*((volatile uint8_t *)0x4000104A))  // RW, GPIO PA output byte 2
#define R32_PA_CLR              (*((volatile uint32_t *)0x4000104C)) // WZ, GPIO PA clear output: 0=keep, 1=clear
#define R8_PA_CLR_0             (*((volatile uint8_t *)0x4000104C))  // WZ, GPIO PA clear output byte 0
#define R8_PA_CLR_1             (*((volatile uint8_t *)0x4000104D))  // WZ, GPIO PA clear output byte 1
#define R8_PA_CLR_2             (*((volatile uint8_t *)0x4000104E))  // WZ, GPIO PA clear output byte 2
#define R32_PA_PU               (*((volatile uint32_t *)0x40001050)) // RW, GPIO PA pullup resistance enable
#define R8_PA_PU_0              (*((volatile uint8_t *)0x40001050))  // RW, GPIO PA pullup resistance enable byte 0
#define R8_PA_PU_1              (*((volatile uint8_t *)0x40001051))  // RW, GPIO PA pullup resistance enable byte 1
#define R8_PA_PU_2              (*((volatile uint8_t *)0x40001052))  // RW, GPIO PA pullup resistance enable byte 2
#define R32_PA_PD               (*((volatile uint32_t *)0x40001054)) // RW, GPIO PA output open-drain & input pulldown resistance enable
#define R8_PA_PD_0              (*((volatile uint8_t *)0x40001054))  // RW, GPIO PA output open-drain & input pulldown resistance enable byte 0
#define R8_PA_PD_1              (*((volatile uint8_t *)0x40001055))  // RW, GPIO PA output open-drain & input pulldown resistance enable byte 1
#define R8_PA_PD_2              (*((volatile uint8_t *)0x40001056))  // RW, GPIO PA output open-drain & input pulldown resistance enable byte 2
#define R32_PA_DRV              (*((volatile uint32_t *)0x40001058)) // RW, GPIO PA driving capability: 0=8mA, 1=16mA
#define R8_PA_DRV_0             (*((volatile uint8_t *)0x40001058))  // RW, GPIO PA driving capability byte 0
#define R8_PA_DRV_1             (*((volatile uint8_t *)0x40001059))  // RW, GPIO PA driving capability byte 1
#define R8_PA_DRV_2             (*((volatile uint8_t *)0x4000105A))  // RW, GPIO PA driving capability byte 2
#define R32_PA_SMT              (*((volatile uint32_t *)0x4000105C)) // RW, GPIO PA output slew rate & input schmitt trigger: 0=fast,normal, 1=slow,schmitt
#define R8_PA_SMT_0             (*((volatile uint8_t *)0x4000105C))  // RW, GPIO PA output slew rate & input schmitt trigger byte 0
#define R8_PA_SMT_1             (*((volatile uint8_t *)0x4000105D))  // RW, GPIO PA output slew rate & input schmitt trigger byte 1
#define R8_PA_SMT_2             (*((volatile uint8_t *)0x4000105E))  // RW, GPIO PA output slew rate & input schmitt trigger byte 2

/* GPIO PB register */
#define R32_PB_DIR              (*((volatile uint32_t *)0x40001060)) // RW, GPIO PB I/O direction: 0=in, 1=out
#define R8_PB_DIR_0             (*((volatile uint8_t *)0x40001060))  // RW, GPIO PB I/O direction byte 0
#define R8_PB_DIR_1             (*((volatile uint8_t *)0x40001061))  // RW, GPIO PB I/O direction byte 1
#define R8_PB_DIR_2             (*((volatile uint8_t *)0x40001062))  // RW, GPIO PB I/O direction byte 2
#define R8_PB_DIR_3             (*((volatile uint8_t *)0x40001063))  // RW, GPIO PB I/O direction byte 3
#define R32_PB_PIN              (*((volatile uint32_t *)0x40001064)) // RO, GPIO PB input
#define R8_PB_PIN_0             (*((volatile uint8_t *)0x40001064))  // RO, GPIO PB input byte 0
#define R8_PB_PIN_1             (*((volatile uint8_t *)0x40001065))  // RO, GPIO PB input byte 1
#define R8_PB_PIN_2             (*((volatile uint8_t *)0x40001066))  // RO, GPIO PB input byte 2
#define R8_PB_PIN_3             (*((volatile uint8_t *)0x40001067))  // RO, GPIO PB input byte 3
#define R32_PB_OUT              (*((volatile uint32_t *)0x40001068)) // RW, GPIO PB output
#define R8_PB_OUT_0             (*((volatile uint8_t *)0x40001068))  // RW, GPIO PB output byte 0
#define R8_PB_OUT_1             (*((volatile uint8_t *)0x40001069))  // RW, GPIO PB output byte 1
#define R8_PB_OUT_2             (*((volatile uint8_t *)0x4000106A))  // RW, GPIO PB output byte 2
#define R8_PB_OUT_3             (*((volatile uint8_t *)0x4000106B))  // RW, GPIO PB output byte 3
#define R32_PB_CLR              (*((volatile uint32_t *)0x4000106C)) // WZ, GPIO PB clear output: 0=keep, 1=clear
#define R8_PB_CLR_0             (*((volatile uint8_t *)0x4000106C))  // WZ, GPIO PB clear output byte 0
#define R8_PB_CLR_1             (*((volatile uint8_t *)0x4000106D))  // WZ, GPIO PB clear output byte 1
#define R8_PB_CLR_2             (*((volatile uint8_t *)0x4000106E))  // WZ, GPIO PB clear output byte 2
#define R8_PB_CLR_3             (*((volatile uint8_t *)0x4000106F))  // WZ, GPIO PB clear output byte 3
#define R32_PB_PU               (*((volatile uint32_t *)0x40001070)) // RW, GPIO PB pullup resistance enable
#define R8_PB_PU_0              (*((volatile uint8_t *)0x40001070))  // RW, GPIO PB pullup resistance enable byte 0
#define R8_PB_PU_1              (*((volatile uint8_t *)0x40001071))  // RW, GPIO PB pullup resistance enable byte 1
#define R8_PB_PU_2              (*((volatile uint8_t *)0x40001072))  // RW, GPIO PB pullup resistance enable byte 2
#define R8_PB_PU_3              (*((volatile uint8_t *)0x40001073))  // RW, GPIO PB pullup resistance enable byte 3
#define R32_PB_PD               (*((volatile uint32_t *)0x40001074)) // RW, GPIO PB output open-drain & input pulldown resistance enable
#define R8_PB_PD_0              (*((volatile uint8_t *)0x40001074))  // RW, GPIO PB output open-drain & input pulldown resistance enable byte 0
#define R8_PB_PD_1              (*((volatile uint8_t *)0x40001075))  // RW, GPIO PB output open-drain & input pulldown resistance enable byte 1
#define R8_PB_PD_2              (*((volatile uint8_t *)0x40001076))  // RW, GPIO PB output open-drain & input pulldown resistance enable byte 2
#define R8_PB_PD_3              (*((volatile uint8_t *)0x40001077))  // RW, GPIO PB output open-drain & input pulldown resistance enable byte 3
#define R32_PB_DRV              (*((volatile uint32_t *)0x40001078)) // RW, GPIO PB driving capability: 0=8mA, 1=16mA
#define R8_PB_DRV_0             (*((volatile uint8_t *)0x40001078))  // RW, GPIO PB driving capability byte 0
#define R8_PB_DRV_1             (*((volatile uint8_t *)0x40001079))  // RW, GPIO PB driving capability byte 1
#define R8_PB_DRV_2             (*((volatile uint8_t *)0x4000107A))  // RW, GPIO PB driving capability byte 2
#define R8_PB_DRV_3             (*((volatile uint8_t *)0x4000107B))  // RW, GPIO PB driving capability byte 3
#define R32_PB_SMT              (*((volatile uint32_t *)0x4000107C)) // RW, GPIO PB output slew rate & input schmitt trigger: 0=fast,normal, 1=slow,schmitt
#define R8_PB_SMT_0             (*((volatile uint8_t *)0x4000107C))  // RW, GPIO PB output slew rate & input schmitt trigger byte 0
#define R8_PB_SMT_1             (*((volatile uint8_t *)0x4000107D))  // RW, GPIO PB output slew rate & input schmitt trigger byte 1
#define R8_PB_SMT_2             (*((volatile uint8_t *)0x4000107E))  // RW, GPIO PB output slew rate & input schmitt trigger byte 2
#define R8_PB_SMT_3             (*((volatile uint8_t *)0x4000107F))  // RW, GPIO PB output slew rate & input schmitt trigger byte 3

/* GPIO register address offset and bit define */
#define BA_PA                   ((volatile uint8_t *)0x40001040) // point GPIO PA base address
#define BA_PB                   ((volatile uint8_t *)0x40001060) // point GPIO PB base address
...
#define R8_SPI1_CTRL_CFG        (*((volatile uint8_t *)0x40004401))  // RW, SPI1 configuration c
#define R8_SPI1_INTER_EN        (*((volatile uint8_t *)0x40004402))  // RW, SPI1 interrupt enabl
#define R8_SPI1_CLOCK_DIV       (*((volatile uint8_t *)0x40004403))  // RW, SPI1 master clock di
#define R8_SPI1_SLAVE_PRE       (*((volatile uint8_t *)0x40004403))  // RW, SPI1 slave preset va
...
#define R8_SPI1_FIFO_COUNT      (*((volatile uint8_t *)0x40004407))  // RO, SPI1 FIFO count stat
#define R32_SPI1_TOTAL_CNT      (*((volatile uint32_t *)0x4000440C)) // RW, SPI1 total byte coun
#define R16_SPI1_TOTAL_CNT      (*((volatile uint16_t *)0x4000440C)) // RW, SPI1 total byte coun
#define R32_SPI1_FIFO           (*((volatile uint32_t *)0x40004410)) // RW, SPI1 FIFO register
#define R8_SPI1_FIFO            (*((volatile uint8_t *)0x40004410))  // RO/WO, SPI1 FIFO registe
#define R8_SPI1_FIFO_COUNT1     (*((volatile uint8_t *)0x40004413))  // RO, SPI1 FIFO count stat
#define R32_SPI1_DMA_NOW        (*((volatile uint32_t *)0x40004414)) // RW, SPI1 DMA current add
//#define R16_SPI1_DMA_NOW    (*((volatile uint16_t *)0x40004414)) // RW, SPI1 DMA current add
#define R32_SPI1_DMA_BEG        (*((volatile uint32_t *)0x40004418)) // RW, SPI1 DMA begin addre
//#define R16_SPI1_DMA_BEG    (*((volatile uint16_t *)0x40004418)) // RW, SPI1 DMA begin addre
#define R32_SPI1_DMA_END        (*((volatile uint32_t *)0x4000441C)) // RW, SPI1 DMA end address
//#define R16_SPI1_DMA_END    (*((volatile uint16_t *)0x4000441C)) // RW, SPI1 DMA end address
...
#define R8_PWM_CTRL_MOD         (*((volatile uint8_t *)0x40005000))  // RW, PWM mode control
#define R8_PWM_CTRL_CFG         (*((volatile uint8_t *)0x40005001))  // RW, PWM configuration control
#define R8_PWM_CLOCK_DIV        (*((volatile uint8_t *)0x40005002))  // RW, PWM clock divisor
#define R32_PWM_DATA            (*((volatile uint32_t *)0x40005004)) // RW, PWM data holding
#define R8_PWM0_DATA            (*((volatile uint8_t *)0x40005004))  // RW, PWM0 data holding
#define R8_PWM1_DATA            (*((volatile uint8_t *)0x40005005))  // RW, PWM1 data holding
#define R8_PWM2_DATA            (*((volatile uint8_t *)0x40005006))  // RW, PWM2 data holding
#define R8_PWM3_DATA            (*((volatile uint8_t *)0x40005007))  // RW, PWM3 data holding

/* PWM0/1/2/3 register address offset and bit define */
#define BA_PWMX                 ((volatile uint8_t *)0x40005000) // point PWM0/1/2/3 base address
...
/* HSPI register */
#define R32_HSPI_CR             (*((volatile uint32_t *)0x40006000)) // RW, parallel if control
#define R8_HSPI_CFG             (*((volatile uint8_t *)0x40006000))  // RW, parallel if tx/rx cfg
#define R8_HSPI_CTRL            (*((volatile uint8_t *)0x40006001))  // RW, parallel if tx/rx control
#define R8_HSPI_INT_EN          (*((volatile uint8_t *)0x40006002))  // RW, parallel if interrupt enable register
#define R8_HSPI_AUX             (*((volatile uint8_t *)0x40006003))  // RW, parallel if aux
#define R32_HSPI_TX_ADDR0       (*((volatile uint32_t *)0x40006004)) // RW, parallel if dma tx addr0
#define R32_HSPI_TX_ADDR1       (*((volatile uint32_t *)0x40006008)) // RW, parallel if dma tx addr1
#define R32_HSPI_RX_ADDR0       (*((volatile uint32_t *)0x4000600C)) // RW, parallel if dma rx addr0
#define R32_HSPI_RX_ADDR1       (*((volatile uint32_t *)0x40006010)) // RW, parallel if dma rx addr1
#define R16_HSPI_DMA_LEN0       (*((volatile uint16_t *)0x40006014)) // RW, parallel if dma length0
#define R16_HSPI_RX_LEN0        (*((volatile uint16_t *)0x40006016)) // RO, parallel if receive length0
#define R16_HSPI_DMA_LEN1       (*((volatile uint16_t *)0x40006018)) // RW, parallel if dma length1
#define R16_HSPI_RX_LEN1        (*((volatile uint16_t *)0x4000601A)) // RO, parallel if receive length1
#define R16_HSPI_BURST_CFG      (*((volatile uint16_t *)0x4000601C)) // RW, parallel if tx burst config register
#define R8_HSPI_BURST_CNT       (*((volatile uint8_t *)0x4000601E))  // RO, parallel if tx burst count
#define R32_HSPI_UDF0           (*((volatile uint32_t *)0x40006020)) // RW, parallel if
#define R32_HSPI_UDF1           (*((volatile uint32_t *)0x40006024)) // RW, parallel if
#define R32_HSPI_STATUS         (*((volatile uint32_t *)0x40006028)) // RW, parallel if status
#define R8_HSPI_INT_FLAG        (*((volatile uint8_t *)0x40006028))  // RW1, parallel if interrupt flag
#define R8_HSPI_RTX_STATUS      (*((volatile uint8_t *)0x40006029))  // RO, parallel rtx status
#define R8_HSPI_TX_SC           (*((volatile uint8_t *)0x4000602A))  // RW, parallel TX sequence ctrl
#define R8_HSPI_RX_SC           (*((volatile uint8_t *)0x4000602B))  // RW, parallel RX sequence ctrl
...
/* DVP registr */
#define R32_DVP_CR              (*((volatile uint32_t *)0x4000E000)) // RW, DVP control register
#define R8_DVP_CR0              (*((volatile uint8_t *)0x4000E000))  // RW, DVP control register0
#define R8_DVP_CR1              (*((volatile uint8_t *)0x4000E001))  // RW, DVP control register1
#define R8_DVP_INT_EN           (*((volatile uint8_t *)0x4000E002))  // RW, DVP interrupt enable register
#define R16_DVP_ROW_NUM         (*((volatile uint16_t *)0x4000E004)) // RW, DVP row number of a frame indicator register
#define R16_DVP_COL_NUM         (*((volatile uint16_t *)0x4000E006)) // RW, DVP col number of a frame indicator register
#define R32_DVP_DMA_BUF0        (*((volatile uint32_t *)0x4000E008)) // RW, DVP dma buffer0 addr
#define R32_DVP_DMA_BUF1        (*((volatile uint32_t *)0x4000E00c)) // RW, DVP dma buffer1 addr
#define R32_DVP_STATUS          (*((volatile uint32_t *)0x4000E010))
#define R8_DVP_INT_FLAG         (*((volatile uint8_t *)0x4000E010))  // RW1, DVP interrupt flag register
#define R8_DVP_FIFO_ST          (*((volatile uint8_t *)0x4000E011))  // RO, DVP receive fifo status
#define R16_DVP_ROW_CNT         (*((volatile uint16_t *)0x4000E014)) // RO, DVP row count value
#define R16_DVP_COL_CNT         (*((volatile uint16_t *)0x4000E016)) // RO, DVP col count value
...
/* SPI Flash register */
#define R32_SPI_ROM_CTRL        (*((volatile uint32_t *)0x40001018))
#define R8_SPI_ROM_DATA         (*((volatile uint8_t *)0x40001018))  //RW
#define R16_SPI_ROM_CR          (*((volatile uint16_t *)0x4000101A)) //RW
...
/* EMMC register */
#define R16_EMMC_CLK_DIV        (*((volatile uint16_t *)(0x4000A038))) // SD clock divider register, [4:0]:divisor, sdclk1 = 480m/[4:0], default divisor is 20
...
#define R32_EMMC_ARGUMENT       (*((volatile uint32_t *)(0x4000A000))) // SD 32bits command argument register
#define R16_EMMC_CMD_SET        (*((volatile uint16_t *)(0x4000A004))) // SD 16bits cmd setting register, [5:0] is the command index, [9:8] indicate the response tye, [10]==1 indicate need to check the response CRC7, [11]==1 indicate need to check the index of the response
#define R32_EMMC_RESPONSE0      (*((volatile uint32_t *)(0x4000A008))) // SD 128bits response register, [31:0] 32bits
#define R32_EMMC_RESPONSE1      (*((volatile uint32_t *)(0x4000A00c))) // SD 128bits response register, [63:32] 32bits
#define R32_EMMC_RESPONSE2      (*((volatile uint32_t *)(0x4000A010))) // SD 128bits response register, [95:64] 32bits
#define R32_EMMC_RESPONSE3      (*((volatile uint32_t *)(0x4000A014))) // SD 128bits response register, [127:96] 32bits, when response length is 48, the 32bit response data is stored in this register
#define R8_EMMC_CONTROL         (*((volatile uint8_t *)(0x4000A018)))  // SD 8bits control register, [1:0] number of data line will operate, [2]==1 soft reset all the inner logic, [3]==1 enable DMA, [4]==1 reset inner data tran/recv logic, [5]==1 @negedge sample cmd/dat[7:0] lines
#define R8_EMMC_TIMEOUT         (*((volatile uint8_t *)(0x4000A01c)))  // SD 8bits data timeout value, the real timeout time is 4194304*Tsdclk*value
#define R32_EMMC_STATUS         (*((volatile uint32_t *)(0x4000A020))) // SD status:[15:0] number of current successfull tran/recv blocks, [16] current sd cmd line level, [17] current sd dat[0] line level
#define R16_EMMC_INT_FG         (*((volatile uint16_t *)(0x4000A024))) // SD 16bits interrupt flag register
#define R16_EMMC_INT_EN         (*((volatile uint16_t *)(0x4000A028))) // SD 16bits interrupt enable register
#define R32_EMMC_DMA_BEG1       (*((volatile uint32_t *)(0x4000A02C))) // SD 16bits DMA start address register when to operate
#define R32_EMMC_BLOCK_CFG      (*((volatile uint32_t *)(0x4000A030))) // SD 32bits data counter, [15:0] number of blocks this time will tran/recv, [27:16] block sise(byte number) of every block in this time tran/recv
#define R32_EMMC_TRAN_MODE      (*((volatile uint32_t *)(0x4000A034))) // SD TRANSFER MODE register, [0] direction of this time, 1-write sd, 0-read sd, [1] stop at block gap when multiple wr/rd, [2] this time is eMMC boot mode operation
#define R32_EMMC_DMA_BEG2       (*((volatile uint32_t *)(0x4000A03C)))
...
#define R16_ECEC_CTRL           (*((volatile uint16_t *)(0x40007000)))
...
#define R8_ECDC_INT_EN          (*((volatile uint8_t *)(0x40007002)))
...
#define R8_ECDC_INT_FG          (*((volatile uint8_t *)(0x40007006)))
...
#define R32_ECDC_KEY_255T224    (*((volatile uint32_t *)(0x40007008)))
#define R32_ECDC_KEY_223T192    (*((volatile uint32_t *)(0x4000700c)))
#define R32_ECDC_KEY_191T160    (*((volatile uint32_t *)(0x40007010)))
#define R32_ECDC_KEY_159T128    (*((volatile uint32_t *)(0x40007014)))
#define R32_ECDC_KEY_127T96     (*((volatile uint32_t *)(0x40007018)))
#define R32_ECDC_KEY_95T64      (*((volatile uint32_t *)(0x4000701c)))
#define R32_ECDC_KEY_63T32      (*((volatile uint32_t *)(0x40007020)))
#define R32_ECDC_KEY_31T0       (*((volatile uint32_t *)(0x40007024)))

//	the following 4*32-bit registers are used to store initial vector for CTR mode
#define R32_ECDC_IV_127T96      (*((volatile uint32_t *)(0x40007028)))
#define R32_ECDC_IV_95T64       (*((volatile uint32_t *)(0x4000702c)))
#define R32_ECDC_IV_63T32       (*((volatile uint32_t *)(0x40007030)))
#define R32_ECDC_IV_31T0        (*((volatile uint32_t *)(0x40007034)))

#define R32_ECDC_SGSD_127T96    (*((volatile uint32_t *)(0x40007040)))
#define R32_ECDC_SGSD_95T64     (*((volatile uint32_t *)(0x40007044)))
#define R32_ECDC_SGSD_63T32     (*((volatile uint32_t *)(0x40007048)))
#define R32_ECDC_SGSD_31T0      (*((volatile uint32_t *)(0x4000704C)))

#define R32_ECDC_SGRT_127T96    (*((volatile uint32_t *)(0x40007050)))
#define R32_ECDC_SGRT_95T64     (*((volatile uint32_t *)(0x40007054)))
#define R32_ECDC_SGRT_63T32     (*((volatile uint32_t *)(0x40007058)))
#define R32_ECDC_SGRT_31T0      (*((volatile uint32_t *)(0x4000705C)))

#define R32_ECDC_SRAM_ADDR      (*((volatile uint32_t *)(0x40007060)))
#define R32_ECDC_SRAM_LEN       (*((volatile uint32_t *)(0x40007064)))
...
#define BA_RAMX                 ((uint32_t *)0x20020000) // point RAMX base address
#define SZ_RAMX                 0x00018000            // RAMX size, Min:32KB, Max:96KB
#define BA_XBUS                 ((uint32_t *)0x80000000) // point XBUS base address
...
#define R32_USB_CONTROL       (*((volatile uint32_t *)(USB_BASE_ADDR + 0x000))) // USB control & interrupt enable & device address
#define R8_USB_CTRL           (*((volatile uint8_t *)(USB_BASE_ADDR + 0x000)))  // USB base control
#define R8_UHOST_CTRL         (*((volatile uint8_t *)(USB_BASE_ADDR + 0x001)))  // USB actual speed
#define R8_USB_INT_EN         (*((volatile uint8_t *)(USB_BASE_ADDR + 0x002)))  // USB interrupt enable
#define R8_USB_DEV_AD         (*((volatile uint8_t *)(USB_BASE_ADDR + 0x003)))  // USB device address
#define R32_USB_FRAME_NO      (*((volatile uint32_t *)(USB_BASE_ADDR + 0x004)))
#define R16_USB_FRAME_NO      (*((volatile uint16_t *)(USB_BASE_ADDR + 0x004)))
#define R8_USB_SUSPEND        (*((volatile uint8_t *)(USB_BASE_ADDR + 0x006)))
#define R32_USB_STATUS        (*((volatile uint32_t *)(USB_BASE_ADDR + 0x008))) // USB miscellaneous status & interrupt flag & interrupt status
#define R8_USB_SPD_TYPE       (*((volatile uint8_t *)(USB_BASE_ADDR + 0x008)))  // USB actual speed
#define R8_USB_MIS_ST         (*((volatile uint8_t *)(USB_BASE_ADDR + 0x009)))  // USB miscellaneous status
#define R8_USB_INT_FG         (*((volatile uint8_t *)(USB_BASE_ADDR + 0x00a)))  // USB interrupt flag
#define R8_USB_INT_ST         (*((volatile uint8_t *)(USB_BASE_ADDR + 0x00b)))  // USB interrupt status
#define R16_USB_RX_LEN        (*((volatile uint16_t *)(USB_BASE_ADDR + 0x00c))) // USB receiving length
#define R32_USB_BUF_MODE      (*((volatile uint32_t *)(USB_BASE_ADDR + 0x010))) // USB endpoint buffer mode
#define R8_UEP4_1_MOD         (*((volatile uint8_t *)(USB_BASE_ADDR + 0x010)))  // endpoint 4/1 mode
#define R8_UEP2_3_MOD         (*((volatile uint8_t *)(USB_BASE_ADDR + 0x011)))  // endpoint 2/3 mode
#define R8_UEP5_6_MOD         (*((volatile uint8_t *)(USB_BASE_ADDR + 0x012)))  // endpoint 5/6 mode
#define R8_UEP7_MOD           (*((volatile uint8_t *)(USB_BASE_ADDR + 0x013)))  // endpoint 7 mode
#define R8_UH_EP_MOD          R8_UEP2_3_MOD                          // host endpoint mode
#define R32_UEP0_RT_DMA       (*((volatile uint32_t *)(USB_BASE_ADDR + 0x014))) // endpoint 0 DMA RX buffer address
#define R32_UEP1_RX_DMA       (*((volatile uint32_t *)(USB_BASE_ADDR + 0x018))) // endpoint 1 DMA RX buffer address
#define R32_UEP2_RX_DMA       (*((volatile uint32_t *)(USB_BASE_ADDR + 0x01c))) // endpoint 2 DMA RX buffer address
#define R32_UEP3_RX_DMA       (*((volatile uint32_t *)(USB_BASE_ADDR + 0x020))) // endpoint 3 DMA RX buffer address
#define R32_UEP4_RX_DMA       (*((volatile uint32_t *)(USB_BASE_ADDR + 0x024))) // endpoint 4 DMA RX buffer address
#define R32_UEP5_RX_DMA       (*((volatile uint32_t *)(USB_BASE_ADDR + 0x028))) // endpoint 5 DMA RX buffer address
#define R32_UEP6_RX_DMA       (*((volatile uint32_t *)(USB_BASE_ADDR + 0x02C))) // endpoint 6 DMA RX buffer address
#define R32_UEP7_RX_DMA       (*((volatile uint32_t *)(USB_BASE_ADDR + 0x030))) // endpoint 7 DMA RX buffer address
...
#define R32_UEP1_TX_DMA       (*((volatile uint32_t *)(USB_BASE_ADDR + 0x034))) // endpoint 1 DMA TX buffer address
#define R32_UEP2_TX_DMA       (*((volatile uint32_t *)(USB_BASE_ADDR + 0x038))) // endpoint 2 DMA TX buffer address
#define R32_UEP3_TX_DMA       (*((volatile uint32_t *)(USB_BASE_ADDR + 0x03C))) // endpoint 3 DMA TX buffer address
#define R32_UEP4_TX_DMA       (*((volatile uint32_t *)(USB_BASE_ADDR + 0x040))) // endpoint 4 DMA TX buffer address
#define R32_UEP5_TX_DMA       (*((volatile uint32_t *)(USB_BASE_ADDR + 0x044))) // endpoint 5 DMA TX buffer address
#define R32_UEP6_TX_DMA       (*((volatile uint32_t *)(USB_BASE_ADDR + 0x048))) // endpoint 6 DMA TX buffer address
#define R32_UEP7_TX_DMA       (*((volatile uint32_t *)(USB_BASE_ADDR + 0x04C))) // endpoint 7 DMA TX buffer address
#define R16_UEP0_MAX_LEN      (*((volatile uint16_t *)(USB_BASE_ADDR + 0x050)))
#define R16_UEP1_MAX_LEN      (*((volatile uint16_t *)(USB_BASE_ADDR + 0x054)))
#define R16_UEP2_MAX_LEN      (*((volatile uint16_t *)(USB_BASE_ADDR + 0x058)))
#define R16_UEP3_MAX_LEN      (*((volatile uint16_t *)(USB_BASE_ADDR + 0x05C)))
#define R16_UEP4_MAX_LEN      (*((volatile uint16_t *)(USB_BASE_ADDR + 0x060)))
#define R16_UEP5_MAX_LEN      (*((volatile uint16_t *)(USB_BASE_ADDR + 0x064)))
#define R16_UEP6_MAX_LEN      (*((volatile uint16_t *)(USB_BASE_ADDR + 0x068)))
#define R16_UEP7_MAX_LEN      (*((volatile uint16_t *)(USB_BASE_ADDR + 0x06C)))
#define R16_UH_RX_MAX_LEN     R16_UEP2_MAX_LEN
#define R32_USB_EP0_CTRL      (*((volatile uint32_t *)(USB_BASE_ADDR + 0x070))) // endpoint 0 control & transmittal length
#define R16_UEP0_T_LEN        (*((volatile uint16_t *)(USB_BASE_ADDR + 0x070))) // endpoint 0 transmittal length
#define R8_UEP0_TX_CTRL       (*((volatile uint8_t *)(USB_BASE_ADDR + 0x072)))  // endpoint 0 tx control
#define R8_UEP0_RX_CTRL       (*((volatile uint8_t *)(USB_BASE_ADDR + 0x073)))  // endpoint 0 rx control

#define R32_USB_EP1_CTRL      (*((volatile uint32_t *)(USB_BASE_ADDR + 0x074))) // endpoint 1 control & transmittal length
#define R16_UEP1_T_LEN        (*((volatile uint16_t *)(USB_BASE_ADDR + 0x074))) // endpoint 1 transmittal length
#define R8_UEP1_TX_CTRL       (*((volatile uint8_t *)(USB_BASE_ADDR + 0x076)))  // endpoint 1 control
#define R8_UEP1_RX_CTRL       (*((volatile uint8_t *)(USB_BASE_ADDR + 0x077)))  // endpoint 1 control

//#define R8_UH_SETUP             R8_UEP1_TX_CTRL	// host aux setup
#define R32_USB_EP2_CTRL      (*((volatile uint32_t *)(USB_BASE_ADDR + 0x078))) // endpoint 2 control & transmittal length
#define R16_UEP2_T_LEN        (*((volatile uint16_t *)(USB_BASE_ADDR + 0x078))) // endpoint 2 transmittal length
#define R8_UEP2_TX_CTRL       (*((volatile uint8_t *)(USB_BASE_ADDR + 0x07A)))  // endpoint 2 control
#define R8_UEP2_RX_CTRL       (*((volatile uint8_t *)(USB_BASE_ADDR + 0x07B)))  // endpoint 2 control
...
#define R32_USB_EP3_CTRL      (*((volatile uint32_t *)(USB_BASE_ADDR + 0x07C))) // endpoint 3 control & transmittal length
#define R16_UEP3_T_LEN        (*((volatile uint16_t *)(USB_BASE_ADDR + 0x07C))) // endpoint 3 transmittal length
#define R8_UEP3_TX_CTRL       (*((volatile uint8_t *)(USB_BASE_ADDR + 0x07E)))  // endpoint 3 control
#define R8_UEP3_RX_CTRL       (*((volatile uint8_t *)(USB_BASE_ADDR + 0x07F)))  // endpoint 3 control
...
#define R32_USB_EP4_CTRL      (*((volatile uint32_t *)(USB_BASE_ADDR + 0x080))) // endpoint 4 control & transmittal length
#define R16_UEP4_T_LEN        (*((volatile uint16_t *)(USB_BASE_ADDR + 0x080))) // endpoint 4 transmittal length
#define R8_UEP4_TX_CTRL       (*((volatile uint8_t *)(USB_BASE_ADDR + 0x082)))  // endpoint 4 control
#define R8_UEP4_RX_CTRL       (*((volatile uint8_t *)(USB_BASE_ADDR + 0x083)))  // endpoint 4 control

#define R16_UH_SPLIT_DATA     R16_UEP4_T_LEN

#define R32_USB_EP5_CTRL      (*((volatile uint32_t *)(USB_BASE_ADDR + 0x084))) // endpoint 5 control & transmittal length
#define R16_UEP5_T_LEN        (*((volatile uint16_t *)(USB_BASE_ADDR + 0x084))) // endpoint 5 transmittal length
#define R8_UEP5_TX_CTRL       (*((volatile uint8_t *)(USB_BASE_ADDR + 0x086)))  // endpoint 5 control
#define R8_UEP5_RX_CTRL       (*((volatile uint8_t *)(USB_BASE_ADDR + 0x087)))  // endpoint 5 control

#define R32_USB_EP6_CTRL      (*((volatile uint32_t *)(USB_BASE_ADDR + 0x088))) // endpoint 6 control & transmittal length
#define R16_UEP6_T_LEN        (*((volatile uint16_t *)(USB_BASE_ADDR + 0x088))) // endpoint 6 transmittal length
#define R8_UEP6_TX_CTRL       (*((volatile uint8_t *)(USB_BASE_ADDR + 0x08A)))  // endpoint 6 control
#define R8_UEP6_RX_CTRL       (*((volatile uint8_t *)(USB_BASE_ADDR + 0x08B)))  // endpoint 6 control

#define R32_USB_EP7_CTRL      (*((volatile uint32_t *)(USB_BASE_ADDR + 0x08C))) // endpoint 7 control & transmittal length
#define R16_UEP7_T_LEN        (*((volatile uint16_t *)(USB_BASE_ADDR + 0x08C))) // endpoint 7 transmittal length
#define R8_UEP7_TX_CTRL       (*((volatile uint8_t *)(USB_BASE_ADDR + 0x08E)))  // endpoint 7 control
#define R8_UEP7_RX_CTRL       (*((volatile uint8_t *)(USB_BASE_ADDR + 0x08F)))  // endpoint 7 control
...
{
    volatile uint32_t LINK_CFG;
    volatile uint32_t LINK_CTRL;
    volatile uint32_t LINK_INT_CTRL;
    volatile uint32_t LINK_INT_FLAG;
    volatile uint32_t LINK_STATUS;
    volatile uint32_t LINK_HP_BUF_CTRL;
    volatile uint32_t LINK_ERR_STATUS;
    volatile uint32_t LINK_ERR_CNT;
    volatile uint32_t USB_CONTROL;
    volatile uint32_t USB_STATUS;
    volatile uint32_t HOST_STATUS;
    volatile uint32_t USB_RX_LEN;
    volatile uint32_t USB_ITP;
    volatile uint32_t USB_ITP_ADJ;
    volatile uint32_t LINK_ISO_DLY;
    volatile uint32_t LINK_STREAM_ID;
    volatile uint32_t LINK_ROUTE_STRING;
    volatile uint32_t USB_FC_CTRL;
    volatile uint32_t LMP_TX_DATA0;
    volatile uint32_t LMP_TX_DATA1;
    volatile uint32_t LMP_TX_DATA2;
    volatile uint32_t LMP_PORT_CAP;
    volatile uint32_t LMP_RX_DATA0;
    volatile uint32_t LMP_RX_DATA1;
    volatile uint32_t LMP_RX_DATA2;
    volatile uint32_t TP_RX_DATA0;
    volatile uint32_t TP_RX_DATA1;
    volatile uint32_t TP_RX_DATA2;
    volatile uint32_t UEP_CFG;
    volatile uint32_t UEP0_DMA;
    volatile uint32_t UEP0_RX_CTRL;
    volatile uint32_t UEP0_TX_CTRL;
    ...
    volatile uint32_t UEP2_RX_CTRL;
    volatile uint32_t UEP2_TX_CTRL;
    volatile uint32_t UEP3_TX_DMA;
    volatile uint32_t UEP3_RX_DMA;
    volatile uint32_t UEP3_RX_CTRL;
    volatile uint32_t UEP3_TX_CTRL;
    volatile uint32_t UEP4_TX_DMA;
    volatile uint32_t UEP4_RX_DMA;
    volatile uint32_t UEP4_RX_CTRL;
    volatile uint32_t UEP4_TX_CTRL;
    volatile uint32_t UEP5_TX_DMA;
    volatile uint32_t UEP5_RX_DMA;
    volatile uint32_t UEP5_RX_CTRL;
    volatile uint32_t UEP5_TX_CTRL;
    volatile uint32_t UEP6_TX_DMA;
    volatile uint32_t UEP6_RX_DMA;
    volatile uint32_t UEP6_RX_CTRL;
    volatile uint32_t UEP6_TX_CTRL;
    volatile uint32_t UEP7_TX_DMA;
    volatile uint32_t UEP7_RX_DMA;
    volatile uint32_t UEP7_RX_CTRL;
    volatile uint32_t UEP7_TX_CTRL;
    volatile uint32_t UX_EXIT_TIMER;
...
typedef struct __PACKED
{
    ...
    volatile uint32_t UH_TX_DMA;
    volatile uint32_t UH_RX_DMA;
    volatile uint32_t UH_RX_CTRL;
    volatile uint32_t UH_TX_CTRL;
} USBSSH_TypeDef;
...
typedef struct __PACKED _UDISK_BOC_CBW
{
    ...
    uint8_t  mCBW_Flag;    /* Input: flags such as transmission direction */
    uint8_t  mCBW_LUN;
...
typedef struct
{
    volatile uint32_t SDS_CTRL;
    volatile uint32_t SDS_INT_EN;
    volatile uint32_t SDS_STATUS;
    volatile uint32_t SDS_RTX_CTRL;
    volatile uint32_t SDS_RX_LEN0;
    volatile uint32_t SDS_DATA0;
    volatile uint32_t SDS_DMA0;
    volatile uint32_t SDS_RX_LEN1;
    volatile uint32_t SDS_DATA1;
    volatile uint32_t SDS_DMA1;
} SDS_TypeDef;
